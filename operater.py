...
can_apply = report_card["국어"] < 3 and report_card["수학"] < 3 and report_card["영어"] <= 6
print("지원가능여부 : ", can_apply)

total_score = report_card["국어"] + report_card["수학"] + report_card["영어"]
print("3합:", total_score)
print("3합 6 이하 여부:", total_score <= 6)
